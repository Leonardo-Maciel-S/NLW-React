      ...
      <div className="max-w-3xl w-full px-6 text-center  space-y-10">
        ...
        <div className='space-y-4'> 
          <div className="h-16 bg-zinc-900 px-4 rounded-xl flex items-center shadow-shape gap-3">
            ...
            {isGuestsInputOpen ? (
              <button onClick={closeGuestInput} className='bg-zinc-800 text-zinc-200 rounded-lg px-5 py-2 font-medium flex items-center gap-2 hover:bg-zinc-700'>Alterar local/data <Settings2/> </button>
            ): (
        ...
        <div className='fixed inset-0 bg-black/60 flex items-center justify-center'>
          ...
          <div className='w-[640px] rounded-xl py-5 px-6 shadow-shape bg-zinc-900 space-y-5'>
            ...
            <div className='space-y-2'>
              ...
              <p className='text-sm text-zinc-400'>Os convidados itão receber e-emails para confirmar a participação na viagem.</p>
            </div>
        ...
        <div className='fixed inset-0 bg-black/60 flex items-center justify-center'>
          ...
          <div className='w-[640px] rounded-xl py-5 px-6 shadow-shape bg-zinc-900 space-y-5'>
            ...
            <form onSubmit={addNewEmailToInvite} className='space-y-3 '>
              ...
              <button
                type='submit'
                className='w-full bg-lime-300 text-lime-950 rounded-lg px-5 h-10 font-medium flex items-center justify-center gap-2 hover:bg-lime-400'>
